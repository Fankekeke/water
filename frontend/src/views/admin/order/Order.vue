            ...
            <a-col :md="6" :sm="24">
              <a-form-item
                ...
                <a-select
                  ...
                  <a-select-option key="2">待发货</a-select-option>
                  <a-select-option key="3">待收货</a-select-option>
                  <a-select-option key="4">已完成</a-select-option>
                  <a-select-option key="5">已取消</a-select-option>
                </a-select>
              </a-form-item>
            </a-col>
          </div>
      ...
      return [{
        ...
        customRender: (text, row, index) => {
          switch (text) {
            ...
            case 2:
              return <a-tag color="blue">待发货</a-tag>
            case 3:
              return <a-tag color="blue">待收货</a-tag>
            case 4:
